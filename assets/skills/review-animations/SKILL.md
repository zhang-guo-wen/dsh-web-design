...
description: Reviews animation and motion code against a high craft bar derived
  from Emil Kowalski's design engineering philosophy. Default to flagging;
  approval is earned.
metadata:
  ...
  od:
    ...
    example_prompt: >
      Review the animation and motion code in the current artifact against a
      high craft bar — check easing, duration, origin, interruptibility, GPU
