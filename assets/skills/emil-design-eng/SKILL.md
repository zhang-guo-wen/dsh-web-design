  ...
  od:
    ...
    craft:
      requires:
        ...
        - anti-ai-slop
    example_prompt: >
      Help me build interfaces that feel right — consult Emil Kowalski's design
      engineering philosophy for animation decisions, component building, CSS
      mastery, and the invisible details that compound into great software.
---
