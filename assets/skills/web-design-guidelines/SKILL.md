...
description: Review UI code for Web Interface Guidelines compliance by the
  Vercel engineering team. Covers layout, typography, color, motion, and
  accessibility for product UI.
metadata:
  author: vercel
  version: 1.0.0
  ...
  od:
    ...
    preview:
      type: markdown
    example_prompt: >
      Review my UI code against the Vercel Web Interface Guidelines — check
      layout, typography, color, motion, and accessibility compliance.
---
