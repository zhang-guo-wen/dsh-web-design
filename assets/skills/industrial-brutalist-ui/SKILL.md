...
description: Raw mechanical interfaces fusing Swiss typographic print with
  ...
  od:
    ...
    craft:
      requires:
        ...
        - color
    example_prompt: >
      Create an industrial-brutalist interface with rigid grids, tactical
      telemetry motifs, strong typography, and mechanical precision.
---
